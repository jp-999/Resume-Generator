...
// Letter size is commonly used in US & Canada, while A4 is the standard for the rest of the world.
...
export const DEBUG_RESUME_PDF_FLAG = undefined; // use undefined to disable to deal with a weird error message
